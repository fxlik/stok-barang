            ...
            <div class="bread">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('barangMasuk.tampil', $proyek->id)}}">Barang Masuk</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-right">
                                    <form target="_blank" action="{{route('barangMasuk.cetak')}}" method="POST" data-toggle="validator">
                                        @csrf
                                        <input type="hidden" name="nama_proyek" value="{{$proyek->nama_proyek}}">
                                        <input type="hidden" name="jenis" value="Barang Masuk">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>: Barang Masuk / {{$transaksi->kode_transaksi}}</td>
                                </tr>
                                <tr>
                                    <td><b>Tanggal</b></td>
                        ...
                        <div class="col-lg-12">
                            <p><b>FORM BARANG BARU:</b></p>
                            <form class="form-horizontal" role="role" method="POST" action="{{route('submitTransaksiMasuk.post')}}" data-toggle="validator">
                                @csrf
                                <input type="hidden" name="transaksi_id" value="{{$transaksi->id}}">
