            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="tombolan" style="margin-bottom:10px;">
                        <a id="tambah_transaksi" class="btn btn-md btn-success" href="#">Transaksi Baru</a>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div id="form_transaksi" style="display:none;">
                                ...
                                <form action="{{route('transaksiKeluar.post')}}" class="form-horizontal" role="form" data-toggle="validator" method="POST">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-sm btn-success add" id="buatTransaksiMasuk">Buat Transaksi</button>
                                </form>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->tgl}}</td>
                                            <td>
                                                <a class="btn btn-sm btn-success" href="{{route('kelolaTransaksi.keluar', [$proyek->id, $item->id])}}">Kelola</a>
                                                <button class="btn btn-sm btn-danger" onclick="location.href='{{route('transaksiKeluar.delete', $item->id)}}'">Hapus</button>
                                                {{-- <button class="btn btn-sm btn-primary" href="{{route('kelolaTransaksi.keluar', [$proyek->id, $item->id])}}">Kelola</button> --}}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="col-md-4">
                            {{-- <p style="font-size:16px; color:seagreen;">Daftar Transaksi Barang Keluar</p> --}}
                        </div>
                    </div>
                </div>
            </div>
